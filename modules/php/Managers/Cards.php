...
class Cards extends \GNC\Helpers\Pieces
{
  ...
  public static function getUiData($currentPlayerId)
  {
    ...
    foreach (Players::getAll() as $pId => $player) {
      ...
      $data[$pId] = [
        'hand' => $isCurrent ? $player->getCardsInHand()->toArray() : [],
        'nHand' => $player->getCardsInHand()->count(),
        ...
        'ballons' => [
          static::bindCard($player->getBalloons(0)),
          static::bindCard($player->getBalloons(1)),
          static::bindCard($player->getBalloons(2)),
        ],
